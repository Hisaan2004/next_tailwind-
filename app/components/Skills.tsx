...
const Skills = () => {
  ...
  return (
    <div className=' flex flex-col items-center justify-center bg-black text-white px-4 flex-grow'>
    ...
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 w-full max-w-5xl mt-10 mb-10'>
      <div>
        ...
        {
            open && (
                <div className='font-semibold flex justify-center bg-gray-200 text-black border border-2 pt-2 pb-4 mr-2 h-50'>
